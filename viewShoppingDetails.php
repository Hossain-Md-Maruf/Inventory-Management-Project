<?php
    ...
    if(isset($_GET['id'])){
        ...
        $sql1= "SELECT SUM(quantity) as total_quantity, SUM(price) as total_price, productName from shooppinginfo WHERE productID=$product_id and userID=$id limit 1";
                    ...
                    <div class="row pt-20" >
                        ...
                        <div class="col-sm-7" >
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <h2 style="color: whitesmoke;"><?php echo ucwords($res1['productName']) ?></h2>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <h2 style="color: whitesmoke;"><?php echo $res1['total_quantity'] ?></h2>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <label class="pull-right"><h2> Price (for 1pcs):</h2></label>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <h2 style="color: whitesmoke;"><?php echo $res1['total_price'] ?></h2>
                                </div>
                            </div>
